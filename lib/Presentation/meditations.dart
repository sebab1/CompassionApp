...
String desc1 = "En kort meditation for begyndere som kan udføres siddende i løbet af dagen.";
String audio1 = "assets/sounds/Meditation_1_5_min_meditation.mp3";

// 2.
String title2 = "Compassion i åndedrættet";
String desc2 = "En længere meditation med fokus på kærlig venlighed og omsorg for dig selv og andre.";
...
String desc3 = "10 minutters meditation for begyndere med fokus på kærlig venlighed";
String audio3 = "assets/sounds/Meditation_3_Loving_Kindness_Meditation_for_begyndere.mp3";

// 4.
String title4 = "Opmærksomhedstræning med åndedrættet";
String desc4 = "En kort opmærksomhedstræning med fokus på nærvær, lyde og åndedræt.";
String audio4 = "assets/sounds/Meditation_4_Opmaerksomhedstraening_med_aandedraettet.mp3";
...
String desc6 = "5 minutters pause til at mærke dig selv og give dig selv omsorg, hvis noget er svært.";
String audio6 = "assets/sounds/Meditation_6_Selvcompassion_pause.mp3";

// 7.
String title7 = "Vejrtrækningen som anker og en dejlig dag";
String desc7 = "5 minutters meditation med fokus på vejrtrækningen og brug af vejrtrækningen som ankerpunkt.";
String audio7 = "assets/sounds/Meditation_7_Vejrtraekningen_som_anker_og_en_dejlig_dag.mp3";
...
String desc9 = "Åndedræt og afslapning er de første skridt til at tæmme sindet. Denne meditation stammer fra bogen: Den magiske butik - En neurokirurgs søgen efter hjernens mysterier og hjertets hemmeligheder af læge James Doty.";
String audio9 = "assets/sounds/Ruths_trick_nr_1.mp3";

// 10.
String title10 = "Ruths trick - Få værktøjer til at åbne dit hjerte";
String desc10 = "Det betyder noget, at du har et åbent hjerte. Et åbent hjerte får kontakt med andre, og det ændrer alting. Denne meditation stammer fra bogen: Den magiske butik - En neurokirurgs søgen efter hjernens mysterier og hjertets hemmeligheder af læge James Doty.";
